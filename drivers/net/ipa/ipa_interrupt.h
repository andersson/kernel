...
enum ipa_irq_id {
	...
	IPA_IRQ_COUNT,		/* Number of interrupts (not an index) */
};
 ...
 * had been signaled.  This is needed to work around a problem that
 * occurs if aggregation is active on an endpoint when its underlying
