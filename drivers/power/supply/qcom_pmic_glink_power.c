...
#define BATT_STATUS		1
#define BATT_HEALTH		2
#define BATT_PRESENT		3
#define BATT_CHG_TYPE		4
#define BATT_CAPACITY		5
#define BATT_SOH		6
#define BATT_VOLT_OCV		7
#define BATT_VOLT_NOW		8
#define BATT_VOLT_MAX		9
#define BATT_CURR_NOW		10
#define BATT_CHG_CTRL_LIM	11
#define BATT_CHG_CTRL_LIM_MAX	12
#define BATT_TEMP		13
...
#define USB_ONLINE		1
#define USB_VOLT_NOW		2
#define USB_VOLT_MAX		3
#define USB_CURR_NOW		4
#define USB_CURR_MAX		5
#define USB_INPUT_CURR_LIMIT	6
#define USB_TYPE		7
#define USB_ADAP_TYPE		8
#define USB_MOISTURE_DET_EN	9
#define USB_MOISTURE_DET_STS	10

#define WLS_ONLINE		1
#define WLS_VOLT_NOW		2
#define WLS_VOLT_MAX		3
#define WLS_CURR_NOW		4
#define WLS_CURR_MAX		5
#define WLS_TYPE		6
#define WLS_BOOST_EN		7
...
struct pmic_glink_power {
	...
	/*
	 * @lock is used to prevent concurrent requests to the firmware, as it
